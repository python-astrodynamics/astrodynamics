...
class TestIsclose:
    ...
    def test_negative_tolerances(self, isclose_function):
    ...
    def test_integers(self, a, b, isclose_function):
        assert isclose_function(a, b, rel_tol=1e-8)
        assert not isclose_function(a, b, rel_tol=1e-9)

    @pytest.mark.parametrize('a, b', decimal_examples)
    def test_decimals(self, a, b, isclose_function):
    ...
    def test_fractions(self, a, b, isclose_function):
        assert isclose_function(a, b, rel_tol=1e-8)
        assert not isclose_function(a, b, rel_tol=1e-9)
